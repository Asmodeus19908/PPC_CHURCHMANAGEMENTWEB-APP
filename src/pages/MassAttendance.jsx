              ...
              <Box
                ...
                sx={{
                  ...
                  bgcolor: isConfirmed
                    ...
                    ? '#2E7D32'
                    : '#fff',
                  color: isSelected || isScheduled || isConfirmed ? '#fff' : '#000',
                  borderRadius: 2,
                  fontWeight: isSelected || isScheduled || isConfirmed ? '700' : '400',
                  textAlign: 'center',
                  lineHeight: '40px',
                  ...
                  '&:hover': {
                    bgcolor:
                      isScheduled && !isSelected && !attendanceConfirmed ? '#1B5E20' : undefined,
